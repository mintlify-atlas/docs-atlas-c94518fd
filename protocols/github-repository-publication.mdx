...
description: "A phase-gated protocol for preparing a GitHub repository for clean publication — audit, classify, and close all risks before any commit, push, or Pages setup."
---
