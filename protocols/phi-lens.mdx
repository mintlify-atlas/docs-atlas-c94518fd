---
title: "PHI-Lens Protocol v4.a: Constraint-Aware Reasoning with Named Objects"
sidebarTitle: "PHI-Lens"
description: "PHI-Lens Protocol v4.a governs non-trivial AI tasks where constraints interact — using named objects (BORDER, LENS, GATE, COUPLING) to prevent flat compromises."
---
...
When a FIDELITY_BORDER is active (facts, data, source material, code, law, medicine, finance, current information, named entities, or uploaded files), the following domain rules apply:
