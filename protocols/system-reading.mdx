...
description: "System Reading Protocol v0.2 extracts the operative principle that explains the gap between a system's declared intent and its observable behavior — before any solutions are proposed."
---
