...
description: "Tiered behavioral contract for AI agents generating PowerShell WinForms apps — UI thread safety, layout containers, STA hosting, and verification rules."
---
